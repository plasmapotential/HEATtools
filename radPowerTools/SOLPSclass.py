...
class SOLPS_IO:
    ...
    def getXYfromGeom(self):
        ...
        self.xGrid[2::6] = self.geometry['crx']['data'][3*Ncells:4*Ncells]
        self.xGrid[3::6] = self.geometry['crx']['data'][2*Ncells:3*Ncells]
        ...
        self.yGrid[2::6] = self.geometry['cry']['data'][3*Ncells:4*Ncells]
        self.yGrid[3::6] = self.geometry['cry']['data'][2*Ncells:3*Ncells]
